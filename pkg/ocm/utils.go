...
func HandleOCMResponse(ctx context.Context, log sdkClient.Logger, response response, requestType string, err error) error {
	...
	// TODO: Remove this workaround once https://github.com/openshift-online/ocm-api-metamodel/issues/XXX is fixed
	// The bug was introduced in metamodel v0.0.51 (commit 88b5c6b)
